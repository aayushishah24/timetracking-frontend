...
var a = localStorage.getItem("firstName")
    ...
    return <tbody>
      {
        projectsData.map((row) =>{
          ...
          //     // if (row._id==res.data.data[0].ptoject._id){
          ...
          const button = (e)=>{
            e.preventDefault()
            navigate(`/Project-Module/${row._id}`)
          }
          return(
            <tr>
			   <td><button type = "button" onClick={button}>{row.projectName}</button></td>
			   <td><button type = "button" onClick={button}>{row.description}</button></td>
			   ...
			   <td><button type = "button" onClick={button}>{row.technology}</button></td>
         <td> 
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
            ...
            {console.log(axios.get("http://localhost:4000/user"))}
            { 
            // (axios.get("http://localhost:4000/user").data.role.roleName === 'admin') && 
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z" />
        ...
        <main class="content">
          <div class="container-fluid p-0">
            <h1>WELCOME {a}</h1><br></br>
            <Link to='/Form' class='tag'target='_self'>Add Project</Link>

            <h2 class="h3 mb-3"><strong>Projects-List</strong></h2><br></br>
